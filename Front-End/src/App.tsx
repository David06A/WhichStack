...
function App ()
{
    ...
    return (
        <div className="App" data-theme={ !isLightMode ? "dark" : "light" }>
            ...
            <div className="card">
                <div
                    className={ `page-container ${ currentPage !== "home" && "hidden"
                        }` }>
                    <HomePage nextPage={ updatePage } />
                </div>
                <div
                    className={ `page-container ${ currentPage !== "question" && "hidden"
                        }` }>
                    <QuestionPage nextPage={ updatePage } />
                </div>
                <div
                    className={ `page-container ${ currentPage !== "recommendation" && "hidden"
                        }` }>
                    <RecommendationPage />
                </div>
            </div>
